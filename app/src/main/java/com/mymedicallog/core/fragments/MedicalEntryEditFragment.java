...
import com.mymedicallog.core.objects.MedicalEntry;

import java.util.ArrayList;
import java.util.Date;


public class MedicalEntryEditFragment extends Fragment {

    private OnFragmentInteractionListener mListener;

    public MedicalEntryEditFragment() {
        // Required empty public constructor
    }

    public static MedicalEntryEditFragment newInstance() {
        MedicalEntryEditFragment fragment = new MedicalEntryEditFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_medical_entry_edit, container, false);
    }
